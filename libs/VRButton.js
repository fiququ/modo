...
class VRButton{
    ...
    showEnterVR(button) {
        ...
        function onSessionStarted(session) {
            ...
            self.stylizeElement(button, false, 18, true); // Reset font size to 12px after starting session
        ...
        function onSessionEnded() {
            ...
            self.stylizeElement(button, true, 18, true); // Reset font size to 12px after ending session
        ...
        button.style.width = '160px'; // Increase width of the button
        ...
        button.onmouseleave = function () {
            ...
            button.style.fontSize = '40px'; // Reset font size to 40px on mouse leave
            button.innerHTML = '<i class="fas fa-vr-cardboard"></i>';
